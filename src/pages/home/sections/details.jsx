function Details(){
    return (
        <div className="bg-surface-cream w-full h-fit max-h-237.5 flex flex-col justify-center items-center py-20 px-4 -z-1 text-brand-dark text-[15px]">
            <img src="/assets/decorations/frame-decoration-1.svg" alt="Line Decoration" className="absolute max-h-237.5  md:object-none z-0"/>
            <div className="z-1">
                <div className="flex flex-row p-5 gap-2">
                    <div className="text-right flex flex-col justify-center items-end mr-5 w-1/2 gap-2">
                    ...
                    <img src="/assets/images/grooms.svg" alt="Ananda Dana Pratama" className="w-2/5"></img>
                </div>
                <div className="flex flex-row p-5 gap-2">
                    <img src="/assets/images/brides.svg" alt="Ananda Dana Pratama" className="w-2/5"></img>
                    <div className="text-left flex flex-col justify-center items-start ml-5 w-1/2 gap-2">
                        ...
                        <img src="/assets/decorations/line-orange.svg" alt="Line Divider" className=""></img>
                        <p className="text-[15px] text-forest-dark font-medium">Daughter of Mr. Iman Irnaman & Mrs. Suhaeti</p>
                    </div>
                </div>
            </div>
        </div>
