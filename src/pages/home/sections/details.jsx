        ...
        <div className="bg-surface-cream w-full h-fit max-h-237.5 flex flex-col justify-center items-center py-20 px-4 -z-1 text-brand-dark text-[15px]">
            ...
            <div className="z-1 overflow-x-hidden">
                <div className="flex flex-row p-5 gap-3">
                    <div data-aos="fade-right" className="text-right flex flex-col justify-center items-end w-3/5 gap-2 ">
                    ...
                    <img data-aos="fade-left" src="/assets/images/grooms.svg" alt="Ananda Dana Pratama" className="w-2/5"></img>
                </div>
                <div className="flex flex-row p-5 gap-3">
                    <img data-aos="fade-right" src="/assets/images/brides.svg" alt="Ananda Dana Pratama" className="w-2/5"></img>
                    <div data-aos="fade-left" className="text-left flex flex-col justify-center items-start w-3/5 gap-2">
