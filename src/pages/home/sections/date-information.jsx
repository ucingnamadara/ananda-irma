...
function DateInformation() {
    ...
    return (
        <div className="bg-surface-cream w-full h-fit flex flex-col justify-center items-center pt-20 px-4 -z-1 text-brand-dark">
            <h1 data-aos="fade-up" className="text-[24px] font-semibold ">Save the Date!</h1>
            <div data-aos="fade-up" className="flex flex-row gap-5 my-6 ">
            ...
            <div data-aos="fade-up" className="flex flex-col gap-1 text-[24px] font-semibold ">
