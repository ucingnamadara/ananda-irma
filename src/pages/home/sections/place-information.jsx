...
function PlaceInformation() {
    return (
        <div className="bg-surface-cream w-full flex flex-col justify-center items-center py-6 px-4 -z-1 text-brand-dark text-[15px] gap-10">
            <img data-animate src="/assets/decorations/house-vector.svg" alt="Leaf Decoration" className="opacity-0 transition-all duration-800"/>
            <div className="">
            ...
            <Button data-animate className = "text-surface-cream bg-brand-dark" label="View Location" href="https://maps.app.goo.gl/4opv1u3iWbRF6TZv8"/>
            <img data-animate src="/assets/images/map-design.svg" alt="Leaf Decoration" className="opacity-0 transition-all duration-800"/>
        </div>
    )
}
