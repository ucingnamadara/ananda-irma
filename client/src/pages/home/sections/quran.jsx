function Quran(){
    ...
    <div className="bg-surface-cream w-full h-[75svh] max-h-237.5 flex flex-col justify-center items-center py-20 px-4 -z-1 text-brand-dark text-[15px]">
        <img data-animate  src="/assets/decorations/background-quran.svg" alt="Leaf Decoration" className="absolute h-[75svh] max-h-237.5  md:object-none z-0  opacity-0 transition-all duration-800"/>
