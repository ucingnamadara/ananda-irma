const PlayButton = ({ isPlaying, setIsPlaying }) => {
    ...
    return (
        <div className="fixed z-99999 max-w-[500px] w-full bottom-0 p-5 flex justify-end">
            <button
                onClick={handleClick}
                className="bg-brand-dark text-surface-cream p-3 rounded-full shadow-lg hover:scale-105 transition-transform duration-200 cursor-pointer"
            >
                {isPlaying ? (
